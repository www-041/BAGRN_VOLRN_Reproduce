...
class TestRunMatcher:
    ...
    def test_device_forwarded_to_learned(self):
        ...
        _run_matcher("lightglue_disk", fake_lightglue, fake_view, "cpu")
        ...
        assert calls[5] == ("lightglue", {"device": "cpu"})
...
class TestRunner:
    ...
    def test_registry_contains_phase_and_sift(self):
        ...
        assert "lightglue_disk" in MATCHERS
        assert callable(MATCHERS["lightglue_disk"])
